      ...
      <div className="flex ">
        <div className="w-1/2 bg-white rounded-r-lg rounded-l-lg flex justify-center items-center signIn">
          <div className="w-full flex flex-col items-center pt-10 gap-6">
            <div className="bg-gray-300 text-black flex justify-center w-14 p-2 px-32 mb-10">
              LOGO
            </div>
            <GoogleAuthButton />
            <h3>or</h3>
            ...
            <div>
              <button
                type="submit"
                className="flex w-full justify-center rounded-md bg-primary px-3 py-1.5 text-md font-semibold leading-6 text-white shadow-sm "
              >
                Sign in
              </button>
            </div>

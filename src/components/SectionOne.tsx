      ...
      <section className="flex-col px-2 py-14 md:py-24 ">
        <div className="flex justify-center align-middle ">
          <div className="relative text-center max-w-3xl lg:max-w-4xl">
            ...
            <h2 className="text-text_dark mx-auto font-medium text-[44px] leading-tight">
              {data?.pre_heading}{" "}
              <span className="text-text_dark">{data?.highlightned}</span>
              <br />
              {data?.post_heading}
            </h2>
            <p className="text-center text-text_dark text-[20px] font-normal leading-normal mt-3 mb-5 mx-auto w-[85%] md:w-[60%]">
              {data?.detail}{" "}
            </p>
          </div>
        </div>

        ...
        <table className="table-auto mt-6 w-full text-sm text-left rtl:text-right text-gray-900 ">
          <thead>
            <tr className="border-b-gray-200 border-b-2 ">
              <th className="pb-2 text-xs text-gray-600">NAME</th>
              <th className="pb-2 text-xs text-gray-600">RELATION</th>
              <th className="pb-2 text-xs text-gray-600">PAN</th>
              <th className="pb-2 text-xs text-gray-600">DOB</th>
              <th className="pb-2 text-xs text-gray-600">ADDRESS</th>
          ...
          <tbody>
            {nomineeData.map((item: NomineeDetail, idx: number) => {
              return (
                <tr key={idx}>
                  <td className="pt-3">{item?.full_legal_name}</td>
                  <td className="pt-3">
                    {/* <select
                  ...
                  <td className="pt-3">{item?.pan}</td>
                  <td className="pt-3">{item?.dob}</td>
                  <td className="pt-3">{item?.address}</td>

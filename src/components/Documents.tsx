        ...
        <span className="ml-4 flex flex-shrink-0 items-start space-x-4">
            <button type="button" className="rounded-md bg-white font-medium text-primary hover:text-primary500 focus:outline-none focus:ring-2 focus:ring-primary500 focus:ring-offset-2">
                <div className='w-[150px]'>
                    <label className="button primary block cursor-pointer">Upload</label>
                    <input type="file" id="aadhaar" accept="image/jpeg,image/jpg,image/png,application/pdf" className='hidden'></input>
                </div>
            </button>
            </span>
    </dd>

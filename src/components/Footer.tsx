...
const Footer = () => {
  return (
    <div className="w-full bg-secondary mt-20">
      <div className="max-w-screen-2xl mx-auto py-6 xl:px-40 md:px-16 px-10">
        <div className="w-full flex flex-wrap items-start gap-20 md:gap-10 lg:gap-0 justify-between mt-20">
          <div className="w-full lg:w-[45%] px-4">
            ...
            <div className="flex gap-4 mt-6">
              ...
              <Link
                ...
                target="_blank"
              >
                <p className="font-extralight hover:text-primary hover:underline font-graphik">
          ...
          <div className="w-full md:w-[45%] lg:w-[30%] px-4">
            <p className="font-extralight font-graphik">
            ...
            <div className="flex justify-center mt-6">
              <div className="bg-gray-100 flex justify-between rounded-lg mt-3 w-full  pl-4 pr-2 py-2">
                <input
                  className="bg-transparent text-black placeholder-black outline-none w-full font-graphik"
                  type="text"
                  placeholder="Enter your email"
                />
                <button className="bg-primary text-white px-4 py-2 font-graphik rounded-lg transition-all hover:shadow-lg hover:-translate-y-1 duration-300">
                  {" "}
                  Subscribe
                </button>
              </div>
          ...
          <div className="w-full md:w-[45%] lg:w-[20%] px-4 flex justify-start lg:justify-end">
            <div className="">
              <div className="">
                <p className="font-semibold mb-4 font-graphik">Call us</p>
                <Link href={"/"} className="font-graphik cursor-pointer">
                  +91 9876543210
                </Link>
              </div>
              <div className="mt-4">
                <p className="font-semibold font-graphik">Follow us</p>
        ...
        <div className="w-full flex flex-col md:flex-row flex-wrap gap-4 md:gap-8 justify-between mt-10">
          <div>
            <Link href={"/"} className="font-graphik font-light">

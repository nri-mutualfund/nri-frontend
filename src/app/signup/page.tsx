                ...
                <div className="flex w-5/12 min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                    ...
                    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                        ...
                        <div>
                                ...
                                <div className="mt-2">
                                    <input id="name" name="name" type="name" placeholder='Name' required className="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6"/>
                                </div>
                            </div>

                            <div>
                                <label htmlFor="email" className="block text-sm font-medium leading-6 text-gray-900">Your Email address</label>
                                <div className=" mt-2 relative">
                                    ...
                                    <span className="absolute inset-y-0 right-0 flex items-center pr-3 ">
                                        {isValidEmail && (
                                            <Link href='/verify'>
                                                <RxArrowRight className="w-5 h-5 font-thin text-primary cursor-pointer "/>
                                            </Link>
                                        )}

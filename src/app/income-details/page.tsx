              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-x-20 border-b border-gray-900/10 pt-12 pb-4">
                ...
                <div className="col-span-4 md:col-span-2">
                  <button
                    type="button"
                    onClick={addTax}
                    className="bg-white text-primary w-full px-2 md:px-8 py-2 rounded-lg cursor-pointer transition-all hover:shadow-lg hover:-translate-y-1 duration-300 border border-primary"
                  >
                    + Add TAX Residency
                  </button>
                </div>

...
import { getAllCategories, getSectionBlog } from "../api/api";
...
const Page = () => {
  ...
  useEffect(()=>{
    getAllCategories().then((response:any)=>{
      console.log(response.data, 'ikjhj')
      setCategory(response.data)       })
  },[])
  console.log(category, 'hghjhg')
  return (
          ...
          <div className="mx-auto xl:px-40 md:px-16 px-10 ">
            ...
            <div className="flex gap-10">
              ...
              <div className="mx-auto my-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 mt-6 lg:mt-28">
                ...
                {console.log(data?.data,'hvbnjhbghnm')}
              ...
              {/* <div className="absolute inset-x-0 bottom-0 h-8 bg-gradient-to-t from-white to-transparent"></div> */}
                    ...
                    <div className="flex w-full items-center justify-between mt-4">
                      ...
                      <span className="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">{post?.blogCategory?.category_name}</span>
                      </div>
                    <div className="relative mt-4 flex justify-between items-center gap-x-4 border-t border-gray-300 w-full py-4">
                   <div className="flex gap-x-4">  <img
                        src={

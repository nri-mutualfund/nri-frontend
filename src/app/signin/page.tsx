                ...
                <div className="flex w-5/12 min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                    <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                        ...
                        <p className="mt-4  text-sm text-gray-600">
                            Not a member?{' '}
                            <a href="/signup" className="font-semibold leading-6 text-primary hover:text-green-600">
                                SignUp
                            </a>
                        </p>
                    </div>
                            ...
                            <div>
                                ...
                                <div className="flex items-center justify-between pt-5">
                                    <label className="block text-gray-600 " >
                                        <input className="ml-2 leading-tight w-3 h-3" type="checkbox" id="remember" name="remember" />
                                        <span className="text-sm">
                                          &nbsp; &nbsp;  Remember me
                                        </span>
                                    </label>
                                    <div className="text-sm">
                                        <a href="#" className="font-semibold text-primary hover:text-green-600">
                                            Forgot password?
                                        </a>
                                    </div>
                                </div>
